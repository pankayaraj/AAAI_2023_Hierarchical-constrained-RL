...
for i in range(no_experiments):
    ...
    HRL_R_safe.append(torch.load("results/grid/safe_lower_hrl_sarsa_key/r" + str(i + 1))[:l])
    HRL_C_safe.append(torch.load("results/grid/safe_lower_hrl_sarsa_key/c" + str(i + 1))[0:l])
