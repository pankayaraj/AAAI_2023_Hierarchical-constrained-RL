...
for i in range(no_experiments):
    ...
    R_HRL_90.append(torch.load("results/grid/safe_upper_bvf_lower_lagrangian/r" + str(i + 1))[:l])
    ...
    R_HRL_G_90.append(torch.load("results/grid/safe_upper_bvf_lower_lagrangian/r" + str(i + 1))[:l])
    C_HRL_G_90.append(torch.load("results/grid/safe_upper_bvf_lower_lagrangian/c" + str(i + 1))[0:l])

    R_k.append(torch.load("results/grid/hrl_sarsa_key/r" + str(i + 1))[:l1])
    C_k.append(torch.load("results/grid/hrl_sarsa_key/c" + str(i + 1))[0:l1])
...
legend = ["unsafe-hrl", "bvf-without_hrl", "safe-hrl-with-lower-level-lagrangian" ]
...
plt.plot(x1, R_k_mean, label=legend[0], linewidth=5)
