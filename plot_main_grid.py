...
legend = ["unsafe-hrl", "bvf-sarsa, limit = 90", "HiLite, Limit = 90",
          "global-bvf-safe-hrl", "bvf-sarsa, limit = 60", "HiLite, Limit = 60", "lpy-sarsa, limit = 60", "lpy-sarsa, limit = 90"]
...
plt.title("Reward comparision with a constriant limis of 60, 90 for 3 goals", size=90)
...
plt.title("Constraint comparision with a constriant limis of 60, 90 for 3 goals", size=90)
