...
for i in range(no_experiments):
    ...
    R_90.append(torch.load("results/grid/safe_sarsa_key/90/r" + str(i + 1))[:l])
    C_90.append(torch.load("results/grid/safe_sarsa_key/90/c" + str(i + 1))[0:l])
    ...
    R_HRL_G_90.append(torch.load("results/grid/safe_global_hrl_sarsa_key/90/r" + str(i + 1))[:l])
