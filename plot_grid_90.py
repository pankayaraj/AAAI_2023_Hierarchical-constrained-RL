...
legend = ["unsafe-hrl", "BVF apporach (90)", "HiLiTE 3 Goals (90)",
          "global-bvf-safe-hrl", "bvf-sarsa, limit = 60", "HiLiTE 7 Goals (90)", "Lyapunov apporach (90)"]
...
lgd = plt.legend(prop={'size':108},loc='upper center', bbox_to_anchor=(0.5, -0.1),
          fancybox=True, shadow=True, ncol=3)
plt.xlabel('No of episodes X1000', size=100)
plt.ylabel("Reward", size=100)
plt.title("Reward comparision with a constriant limit of 90", size=100)
...
plt.axhline(y=90, color='r', linestyle='--',  linewidth=10)
lgd = plt.legend(prop={'size':108},loc='upper center', bbox_to_anchor=(0.5, -0.1),
          fancybox=True, shadow=True, ncol=3)
plt.xlabel('No of episodes X1000', size=100)
plt.ylabel("Constraints", size=100)
plt.title("Constraint comparision with a constriant limit of 90", size=100)
