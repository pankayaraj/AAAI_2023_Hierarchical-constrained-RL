...
axis[0].plot(r, "b")
axis[1].plot(c, "b")
axis[1].axhline(y=90, color='r', linestyle='--')

axis[2].plot(True_list, "r")
axis[3].plot(False_list, "g")
#axis[4].plot(Random, "y")
#axis[4].set_ylim([0, 30])
...
axis[1].legend(["Cost (Evaluation)"])
axis[2].legend(["Minimizes the cost"])
axis[3].legend(["Do not minimize the cost"])
#axis[4].legend(["Random Action"])
